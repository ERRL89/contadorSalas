                                                ...
                                                <tr>
                                                  <td style='line-height: 24px; font-size: 16px; width: 100%; margin: 0; padding: 20px;' align='left'>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td class='col-12' style='line-height: 24px; font-size: 16px; min-height: 1px; font-weight: normal; padding-right: 24px; width: 100%; margin: 0;' align='left' valign='top'>
                                                              <center>
                                                                <img class='img-fluid' src='https://despachocontablesalas.com/intranet/images/logos/logoEmail.png' style='height: auto; line-height: 100%; outline: none; text-decoration: none; display: block; max-width: 100%; width: 100%; border-style: none; border-width: 0;' width='100%'>
                                                              </center>
                                                            </td>
                                                          </tr>
                                                        </tbody>
                                                    ...
                                                    <div>
                                                      ...
                                                      <p class='text-gray-700 text-center' style='line-height: 24px; font-size: 16px; color: #4a5568; width: 100%; margin: 0;' align='center'>SALAS SALAZAR & ASOCIADOS</p>
                                                    </div>
                                                  </td>
                                                </tr>
                                              </tbody>
