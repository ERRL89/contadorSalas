<?php
    ...
    if((isset($_POST['typeService1']) || isset($_POST['listService1'])) && isset($_POST['costo1']) && isset($_POST['total'])){
        $typeService1= $_POST['typeService1'];
        $listService1= $_POST['listService1'];
        $costo1=       $_POST['costo1'];
        $total=        $_POST['total'];
        $partida1=1;
    }
    ...
    if((isset($_POST['typeService2']) || isset($_POST['listService2'])) && isset($_POST['costo2'])){
        $typeService2= $_POST['typeService2'];
        $listService2= $_POST['listService2'];
        $costo2=       $_POST['costo2'];
        
        if(($typeService2!='' || $listService2!='')){
            $partida2=1;    
        }else{ $partida2=0; }
    ...
    if((isset($_POST['typeService3']) || isset($_POST['listService3'])) && isset($_POST['costo3'])){
        $typeService3= $_POST['typeService3'];
        $listService3= $_POST['listService3'];
        $costo3=       $_POST['costo3'];
        
        if(($typeService3!='' || $listService3!='')){
            $partida3=1;    
        }else{ $partida3=0; }
    }
